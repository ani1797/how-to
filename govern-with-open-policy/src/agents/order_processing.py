...
class OrderProcessingAgent(BaseAgent):
    ...
    @tool(
        ...
        "OPA-A enforces per-role transaction-amount caps."
    )
    ...
    # ------------------------------------------------------------------
    @tool(
        "Apply a percent discount to a product. OPA-A caps the discount per role; "
        "OPA-B prevents selling below cost or below MAP."
    )
